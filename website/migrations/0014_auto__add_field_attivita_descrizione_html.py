...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attivita.descrizione_html'
        db.add_column('website_attivita', 'descrizione_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attivita.descrizione_html'
        db.delete_column('website_attivita', 'descrizione_html')


    models = {
        'website.attivita': {
            'Meta': {'object_name': 'Attivita'},
            'collaborazioni': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
